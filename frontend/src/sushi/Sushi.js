...
export class Sushi {
  constructor(provider, networkId, testing, options) {
    ...
    this.sellerPoolAddress = contractAddresses.sellerPool[networkId]
    this.sellerLpTokenAddress = contractAddresses.sellerLpToken[networkId]
    this.wethAddress = contractAddresses.weth[networkId]
    this.usdcWethAddress = contractAddresses.usdcWeth[networkId]
    this.priceLpAddress = contractAddresses.priceLp[networkId]
  }
