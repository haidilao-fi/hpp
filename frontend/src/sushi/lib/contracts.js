...
import SellerPoolAbi from './abi/sellerPool.json'
import SellerLpTokenAbi from './abi/sellerLpToken.json'
...
export class Contracts {
  constructor(provider, networkId, web3, options) {
    ...
    this.sellerPool = new this.web3.eth.Contract(SellerPoolAbi)
    this.sellerLpToken = new this.web3.eth.Contract(SellerLpTokenAbi)
  ...
  setProvider(provider, networkId) {
    ...
    setProvider(this.sellerPool, contractAddresses.sellerPool[networkId])
    setProvider(this.sellerLpToken, contractAddresses.sellerLpToken[networkId])
